package com.blusalt.blusaltmpos.util.utils
...
object PinEncrytUtil {

    fun getWorkingKey(IPEK: String, KSN: String =
        ...
        var sessionkey = "" //Get ksn with a zero counter by ANDing it with 0000FFFFFFFFFFE00000
...
//get the number of binary associated with the counterKSN number
    ...
    fun encryptPinBlock(pan: String, pin: String): String {
        ...
        return XORorANDorORfunction(pan, pin, "^") //the clear pinblock is
      //  returned here
    }

    fun DesEncryptDukpt(workingKey: String, pan: String, clearPin: String):String{
        val pinBlock = XORorANDorORfunction(workingKey, encryptPinBlock(pan,
            clearPin), "^")
...
//
//    fun  getTheFinalPinClock() :String{
//        val pinBlock = DesEncryptDukpt(
//            workingKey = getWorkingKey(3F2216D8297BCE9C),
//            pan = "4187451802979411",
//            clearPin = "3005"
//        )
//        return  pinBlock
