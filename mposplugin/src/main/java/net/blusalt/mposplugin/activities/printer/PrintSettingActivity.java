...
import net.blusalt.mposplugin.DialogFactory;
import net.blusalt.mposplugin.R;
import net.blusalt.mposplugin.activities.mp5801.DeviceAdapter;
import net.blusalt.mposplugin.activities.mp5801.PrintActivity;
