package net.blusalt.mposplugin.activities.printer;
...
import net.blusalt.mposplugin.utils.QRCodeUtil;
import net.blusalt.mposplugin.utils.TRACE;
import net.blusalt.mposplugin.view.BitmapPrintLine;
import net.blusalt.mposplugin.view.MidTextPrintLine;
import net.blusalt.mposplugin.view.PrintLine;
import net.blusalt.mposplugin.view.PrinterLayout;
import net.blusalt.mposplugin.view.TextPrintLine;
